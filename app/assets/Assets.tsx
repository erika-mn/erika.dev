export const companies = [
  {
    ...
    description: [
      {
        key: 1,
        desc: 'Creating websites for clients with seamless execution and meticulous attention to detail using WordPress.',
      },
      {
        key: 2,
        desc: 'Actively collaborating with teammates and the CEO to discuss required deliverables, while also participating in code reviews to improve the codebase and enhance website performance.',
      },
    ],
  },
  {
    id: 2,
    name: 'BCS Technology International Pty Ltd',
...
export const icpep = [
  {
    key: 1,
    desc: 'Successfully configured a LAMP stack (Linux, Apache, MySQL, PHP) on a Linux server deployed through Amazon Web Services (AWS), ensuring a stable and secure environment for web development.',
  },
  {
    key: 2,
    desc: 'Designed and developed a fully functional WordPress website hosted on an AWS EC2 instance, leveraging the scalability and reliability of the AWS infrastructure to deliver a responsive and user-friendly web experience.',
  },
];
